...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    [SPECIES_SPEDIQUIL] = 
    {
        ...
        .cryId = CRY_CYNDAQUIL,
        .natDexNum = NATIONAL_DEX_SPEDIQUIL,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_Spediquil,
        ...
        .palette = gMonPalette_Spediquil,
        .shinyPalette = gMonShinyPalette_Spediquil,
        .iconSprite = gMonIcon_Spediquil,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 3,
        SHADOW(0, -1, SHADOW_SIZE_S)
        FOOTPRINT(Cyndaquil)

        .levelUpLearnset = sSpediquilLevelUpLearnset,
        .teachableLearnset = sSpediquilTeachableLearnset,
